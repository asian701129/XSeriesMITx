...
def simulationDelayedTreatment(numTrials):
    ...
    def returnAnswer(finalVirusPopulations):
        ...
        for a in [0,1,2,3]:
            ...
            counts[a] = count
        for a in [0,1,2,3]:
            props[a] = counts[a]/float(numTrials)
        print "There were", counts, "trials where between 0 and 50 were left out of", numTrials,"total trials"
        print "There were", props, "proportions of successful treatments in", numTrials,"total trials"
...
def simulationTwoDrugsDelayedTreatment(numTrials):
    ...
    allTheData = prepData(100, 1000, 0.1, 0.05, {'guttagonol': False, 'grimpex': False}, 0.005, numTrials)
