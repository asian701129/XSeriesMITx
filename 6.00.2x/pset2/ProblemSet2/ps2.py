...
class RectangularRoom(object):
    ...
    def cleanTileAtPosition(self, pos):
        ...
        pos: a Position
        """
        self.grid[int(pos.getX())][int(pos.getY())] = True
    ...
    def getRandomPosition(self):
        ...
        """
        randomXposition = random.randrange(0, self.width)
        randomYposition = random.randrange(0, self.height)
    ...
    def isPositionInRoom(self, pos):
        ...
        x = pos.getX()
        y = pos.getY()
        if (0.0 <= x and x < self.width and 0.0 <= y and y < self.height):
            return True
        else:
            return False
...
class Robot(object):
    ...
    def __init__(self, room, speed):
        ...
        """
        '''
        mylocation is a Position object corresponding to the current position
        direction is an integer specifying the angle
        '''
        self.myroom = room
        self.mylocation = 0
        self.mylocation = self.myroom.getRandomPosition()
        self.myroom.cleanTileAtPosition(self.mylocation)
        self.speed = speed
    ...
    def setRobotDirection(self, direction):
        ...
        if (0 <= direction and direction < 360):
...
class StandardRobot(Robot):
    ...
    def updatePositionAndClean(self):
        ...
        """
        while(1):
            possibleLocation = self.mylocation.getNewPosition(self.direction,self.speed)
            if self.myroom.isPositionInRoom(possibleLocation):
                self.mylocation = possibleLocation
                break
            else:
                self.direction = random.randint(0,359)
                continue
